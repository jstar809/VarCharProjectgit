        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <p style="font-size: 18px;">똑똑히 알려주는 전문시세</p>
	        	<!-- 
...
<section class="ftco-counter ftco-section img bg-light" id="section-counter">
          ...
          <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text text-border d-flex align-items-center">
                <strong class="number" data-number="5727">0</strong>
                <span>1년동안 <br>거래된차 </span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text text-border d-flex align-items-center">
                <strong class="number" data-number="3206">0</strong>
                <span>총 <br>거래된 차</span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 justify-content-center counter-wrap ftco-animate">
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <h2 class="mb-2">라이브 스튜디오 차량</h2>
          	<span class="subheading">중고차가 어려운 당신을 위한 오토벨 112가지 진단, 홈서비스까지 한 번에 해결하는 차량</span>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-12">
    ...
    <section class="ftco-section ftco-no-pt bg-light">
    	<div class="container">
    		<div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <h2 class="mb-2">오토벨& 차량</h2>
          	<span class="subheading">오토벨과 함께하는 매매단지, 금융인증, 수입인증 차량</span>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-12">
...
-->
		...
		<section class="ftco-section ftco-intro" style="background-image: url(images/bg_3.jpg);">
            ...
            <h2 class="mb-3">지금 회원가입하고<br>
						오토벨의 모든 서비스를 편리하게 이용하세요
            </h2>
            <a href="#" class="btn btn-primary btn-lg">로그인 하기</a>
             <a href="#" class="btn btn-primary btn-lg">회원 가입하기</a>
          </div>
				</div>
			</div>
		</section>

      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <span class="subheading">다른 추천 카</span>
            <h2 class="mb-2">다른 추천 카</h2>
          </div>
        </div>
        <div class="row">
       <!-- 
        
        <c:forEach var="datas" begin="0" end="3" items="${cdatas}">
             ...
             <!-- 제목 -->
              <div class="text">
                ...
                <p class="d-flex mb-0 d-block">
                  <a href="#" class="btn btn-primary py-2 mr-1">예약 하기</a>
	...
	-->
          ...
          <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
              ...
              <div class="text">
                <h2 class="mb-0">
                  <a href="detail.html">Mercedes Grand Sedan</a>
                </h2>
                <div class="d-flex mb-3">
                ...
                <p class="d-flex mb-0 d-block">
                  ...
                  <a href="detail.html" class="btn btn-secondary py-2 ml-1"
                    >Details</a
                  >
                </p>
              </div>
          ...
          <div class="col-md-4">
            <div class="car-wrap rounded ftco-animate">
              ...
              ></div>
              <div class="text">
                <h2 class="mb-0"><a href="detail.html">Range Rover</a></h2>
                <div class="d-flex mb-3">

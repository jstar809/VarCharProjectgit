...
<html>
 <head>
  ...
  <body>
    ...
    >
      <div class="container">
        <a class="navbar-brand" href="main.html">Car<span>Book</span></a>
        <button
      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-8 block-9 mb-md-5 myInfoContainer">
            <form action="mypage.do" class="bg-light p-5 contact-form">
              ...
              <div class="myInfoBox">
                <div class="myInfo firstColumn">
                  ...
                  <div id="deleteMsgBox">
                    ...
                    <div id="deleteMsgBtn">
                      <button id="deleteAll">전부 삭제</button>
                      <button id="deleteOnlyMsg">모두 유지</button>
                      <button type="button" id="stopDelete">탈퇴 취소</button>
                    </div>
